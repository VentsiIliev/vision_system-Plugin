...
def undistortImage(image, mtx, dist, imageWidth=1920, imageHeight=1080, crop=False,optimal_camera_matrix=None,roi=None):
    """
    ...
    if optimal_camera_matrix is not None:
        newcameramtx = optimal_camera_matrix
        roi = roi
    else:
