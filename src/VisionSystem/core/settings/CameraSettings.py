...
class CameraSettings(Settings):
    def __init__(self, data: dict = None):
        ...
        self.set_value(CameraSettingKey.BRIGHTNESS_AREA_P4.value, [940, 660])
    ...
    def updateSettings(self, settings: dict):
        ...
        """
        print(f"UPDATING CAMERA SETTINGS")
        try:
            ...
            # Handle flat brightness area keys
            if CameraSettingKey.BRIGHTNESS_AREA_P1.value in settings:
                self.set_brightness_area_p1(settings[CameraSettingKey.BRIGHTNESS_AREA_P1.value])
            if CameraSettingKey.BRIGHTNESS_AREA_P2.value in settings:
                self.set_brightness_area_p2(settings[CameraSettingKey.BRIGHTNESS_AREA_P2.value])
            if CameraSettingKey.BRIGHTNESS_AREA_P3.value in settings:
                self.set_brightness_area_p3(settings[CameraSettingKey.BRIGHTNESS_AREA_P3.value])
            if CameraSettingKey.BRIGHTNESS_AREA_P4.value in settings:
                self.set_brightness_area_p4(settings[CameraSettingKey.BRIGHTNESS_AREA_P4.value])
            ...
            if "Brightness Control" in settings:
                ...
                # Handle brightness area points in nested structure
                if CameraSettingKey.BRIGHTNESS_AREA_P1.value in brightness:
                    self.set_brightness_area_p1(brightness[CameraSettingKey.BRIGHTNESS_AREA_P1.value])
                if CameraSettingKey.BRIGHTNESS_AREA_P2.value in brightness:
                    self.set_brightness_area_p2(brightness[CameraSettingKey.BRIGHTNESS_AREA_P2.value])
                if CameraSettingKey.BRIGHTNESS_AREA_P3.value in brightness:
                    self.set_brightness_area_p3(brightness[CameraSettingKey.BRIGHTNESS_AREA_P3.value])
                if CameraSettingKey.BRIGHTNESS_AREA_P4.value in brightness:
                    self.set_brightness_area_p4(brightness[CameraSettingKey.BRIGHTNESS_AREA_P4.value])
    ...
    def to_dict(self):
        ...
        nested_data["Brightness Control"] = {
            ...
            # Brightness area points
            CameraSettingKey.BRIGHTNESS_AREA_P1.value: self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P1.value),
            CameraSettingKey.BRIGHTNESS_AREA_P2.value: self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P2.value),
            CameraSettingKey.BRIGHTNESS_AREA_P3.value: self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P3.value),
            CameraSettingKey.BRIGHTNESS_AREA_P4.value: self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P4.value),
        }
    ...
    # ======= BRIGHTNESS AREA METHODS =======
    def get_brightness_area_p1(self):
        """Get brightness area point 1 [x, y]."""
        return self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P1.value)

    def set_brightness_area_p1(self, point):
        """Set brightness area point 1 [x, y]."""
        self.set_value(CameraSettingKey.BRIGHTNESS_AREA_P1.value, point)

    def get_brightness_area_p2(self):
        """Get brightness area point 2 [x, y]."""
        return self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P2.value)

    def set_brightness_area_p2(self, point):
        """Set brightness area point 2 [x, y]."""
        self.set_value(CameraSettingKey.BRIGHTNESS_AREA_P2.value, point)

    def get_brightness_area_p3(self):
        """Get brightness area point 3 [x, y]."""
        return self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P3.value)

    def set_brightness_area_p3(self, point):
        """Set brightness area point 3 [x, y]."""
        self.set_value(CameraSettingKey.BRIGHTNESS_AREA_P3.value, point)

    def get_brightness_area_p4(self):
        """Get brightness area point 4 [x, y]."""
        return self.get_value(CameraSettingKey.BRIGHTNESS_AREA_P4.value)

    def set_brightness_area_p4(self, point):
        """Set brightness area point 4 [x, y]."""
        self.set_value(CameraSettingKey.BRIGHTNESS_AREA_P4.value, point)

    def get_brightness_area_points(self):
        """Get all brightness area points as a list of [x, y] coordinates."""
        return [
            self.get_brightness_area_p1(),
            self.get_brightness_area_p2(),
            self.get_brightness_area_p3(),
            self.get_brightness_area_p4()
        ]

    def set_brightness_area_points(self, points):
        """Set all brightness area points from a list of [x, y] coordinates."""
        if len(points) == 4:
            self.set_brightness_area_p1(points[0])
            self.set_brightness_area_p2(points[1])
            self.set_brightness_area_p3(points[2])
            self.set_brightness_area_p4(points[3])
        else:
